...
function SignUp() {
  ...
  return (
    <section className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="w-full max-w-md bg-Gunmetal rounded-lg shadow dark:border-gray-700">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                <input
                  ...
                  name="owner"
                  id="owner"
                  className="mr-2 rounded dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  checked={isOwner}
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-400 group relative w-max">
              ...
              <a
                href="/login"
                className="font-medium text-white ml-1 relative z-10 group-hover:text-white"
              >
                Sign in
              </a>
